...
ADD COLUMN IF NOT EXISTS contract_id UUID REFERENCES public.ugc_contracts(id),
ADD COLUMN IF NOT EXISTS shipment_required BOOLEAN DEFAULT true,
ADD COLUMN IF NOT EXISTS shipment_id UUID REFERENCES public.ugc_shipments(id);

-- Add contract and shipment tracking to creators
ALTER TABLE public.ugc_creators
ADD COLUMN IF NOT EXISTS contract_template_id UUID REFERENCES public.ugc_contract_templates(id),

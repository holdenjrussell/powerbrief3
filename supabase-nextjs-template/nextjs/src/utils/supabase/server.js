/**
 * Supabase Client for Server-side Usage (JavaScript version)
 * 
 * KEYWORDS: Supabase, server-side, SSR, authentication, database, cookies, JS
 * 
 ...
 * 
 * @returns {Promise<SupabaseClient>} A Supabase client instance for server-side operations
 */
export async function createClient() {
    ...
    return createServerClient(process.env.NEXT_PUBLIC_SUPABASE_URL, process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY, {
        cookies: {
             ...
             * @returns {Array} All cookies from the Next.js cookie store
             */
            getAll() {
             ...
             * @param {Array} cookiesToSet Array of cookies to set with name, value, and options
             */
            setAll(cookiesToSet) {
                try {

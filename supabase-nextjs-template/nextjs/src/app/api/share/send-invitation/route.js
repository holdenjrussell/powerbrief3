...
export async function POST(req) {
    try {
        ...
        const { data: profile } = await supabase
            ...
            .eq('id', user.id)
            .single();
        const senderName = (profile === null || profile === void 0 ? void 0 : profile.full_name) || user.email || 'A colleague';
        ...
        if (shareType === 'batch' && batchId) {
            const { data: batch } = await supabase
                ...
                .eq('id', batchId)
                .single();
            resourceName = (batch === null || batch === void 0 ? void 0 : batch.name) || 'a brief batch';
        }
            ...
            const { data: concept } = await supabase
                ...
                .eq('id', conceptId)
                .single();
            resourceName = (concept === null || concept === void 0 ? void 0 : concept.concept_title) || 'a concept';
        }

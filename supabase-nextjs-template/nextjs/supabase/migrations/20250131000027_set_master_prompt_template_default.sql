-- Migration: Set master prompt template as column default
-- Created: 2025-01-31
-- Purpose: Ensure all new onesheet AI instructions get the master prompt template automatically

-- Set the column default for master_prompt_template
